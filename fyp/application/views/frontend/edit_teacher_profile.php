		...
		<div class="col-lg-6">
			<div class="bg-light my-4 rounded border container">
				...
				<div class="container py-4">
					<?php $teacher = $this->user_model->get_teachers($this->session->userdata('teacher_email')); ?>
					<form action="<?php echo base_url('teacher/change-name'); ?>" method="post">
			            <div class="form-group">
			              <label for="new-name">Update Name</label>
			              <input type="text" class="form-control" id="new-name" name="new-name" value="<?php echo $teacher->name; ?>"  placeholder="Enter New Name" required>
			            </div>

			            <div class="form-group">
					      <label for="bio">Update Bio</label>
					      <textarea id="summernote" class="form-control" rows="4" name="bio" required><?php echo $teacher->bio;?></textarea>
					    </div>
				...
				<div class="row container">
					...
					<div class="col-sm-7 py-4">
						<div class="name text-center text-md-left">
							<h3><?php echo $this->session->userdata('teacher_name'); ?></h3>
							<form action="<?php echo base_url('teacher/change-img'); ?>" method="post" enctype="multipart/form-data">
							    Select image to upload:<br>
							    <input type="file" class="form-control-file my-2 mx-auto mx-md-0" name="teacher_image" required style="width: 180px" >
		...
		<div class="col-12">
			<div class="bg-light rounded border container">
				...
				<div class="container py-4">
					...
					<form action="<?php echo base_url('teacher/change-pass'); ?>" method="post">
			            <div class="form-group">
